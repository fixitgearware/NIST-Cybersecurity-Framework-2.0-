...
<br>
<h4>SUBCATEGORIES NOW INCORPORATED INTO:</h4>
<strong>ID.BE:</strong>&nbsp; (ID.BE-1)-->(GV.OC-5),(ID.BE-2)-->(GV.OC-1), (ID.BE-3)-->(GV.OC-1), (ID.BE-4)-->(GV.OC-4 & GV.OC-5), (ID.BE-5)-->(GV.OC-4).
<br>
<strong>ID.GV:</strong>&nbsp; (ID.GV-1)-->(GV.PO-1 & GV.PO-2),(ID.GV-2)-->(GV.OC-2 & GV.RR-2), (ID.GV-3)-->(GV.OC-3), (ID.GV-4)-->(GV.RM-4).
<br>
<strong>ID.RM:</strong>&nbsp; ID.RM-1-->(GV.RM-1,GV.RM-6 & GV.RR-3),ID.RM-2-->(GV.RM-2 & GV.RM-4), ID.RM-3-->(GV.RM-2).
<br>
<strong>ID.SC:</strong>&nbsp; ID.SC-1-->(GV.RM-5,GV.SC-1,GV.SC-6,GV.SC-9 & GV.SC-10),ID.SC-2-->(GV.OC-2,GV.SC-3,GV.SC-4,GV.SC-7 & ID.RA-10), ID.SC-3-->(GV.SC-5), ID.SC-4-->(GV.SC-7,ID.RA-10), ID.SC-5-->(GV.SC-8 & ID.IM-2).
<br>
