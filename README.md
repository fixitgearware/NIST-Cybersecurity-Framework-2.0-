...
<li><ul><strong><ins>NEW CATEGORY:</ins></strong>&nbsp;&nbsp;Here are listed the new categories introduced in the functions e.g. IDENTIFY->ID-> ID.IM Improvement (New Category in the IDENTIFY Function).</ul></li>
